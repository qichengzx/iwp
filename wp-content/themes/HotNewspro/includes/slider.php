		...
		<div class="featured_post" >
			<div class="slider_image">			
				...
				<?php else: ?>
					...
					<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><img class="home-thumb" src="<?php echo catch_first_image() ?>" width="400px" height="248px" alt="<?php the_title(); ?>"/>
				<?php } ?></a>
				<?php endif; ?>
			</div>
		</div>
