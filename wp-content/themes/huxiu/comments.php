...
<?php if ( have_comments() ) : ?>
	<h3 class="t-h2" id="odby">
            <a href="javascript:;" target="_blank" class="a-btn"><i class="icon-comment"></i><em class="pl-num"><?php comments_number('0', '1', '%' );?></em></a>
            <ul class="inline tab-pinglun-box">
                <li class="active"><a href="javascript:;" target="_self">全部评论</a></li>
            </ul>
        </h3>
...
<h3 class="t-h2" id="odby">
            <ul class="inline tab-pinglun-box">
                <li class="active"><a href="javascript:;" target="_self">发表评论</a></li>
            </ul>
        </h3>
...
<input name="submit" type="submit" id="submit" class="cbg" tabindex="5" value="提 交" />
